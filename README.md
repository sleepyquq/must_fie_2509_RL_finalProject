...
4. Install dependencies:
  ...
  **[!TIP] Hardware Recommendation: We strongly recommend using CPU for this project. Our experiments show that CPU training reliably reproduces the perfect gait (300+ score), whereas GPU training may suffer from instability due to floating-point determinism issues in the physics engine.**  
